...
namespace Delegate
{
    ...
    //принадлежащий не какому объекту , так называемы анонимные методы․
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //------------------------------------------------------------------------------------
            Console.WriteLine($"{new string('=', 10)} Лябда => и Анонимные методы");
            //--------------------------------|Лябда => и Анонимные методы"|----------------------
            MyDelegate delegate4 = delegate (int x, int y) { return x + y; };
